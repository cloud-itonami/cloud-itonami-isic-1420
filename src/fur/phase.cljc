(ns fur.phase
  "Phase table for Fur-Garment Manufacturing Plant Operations state graph.
...
(def phase-table
  "State graph topology for fur-garment-manufacturing plant operations
  coordination.
  Entry: ADVISOR-NODE
  ...
  {:start ADVISOR-NODE
   :nodes {ADVISOR-NODE {:type :function
                         :description "LLM advisor proposes fur-garment plant operations"}
