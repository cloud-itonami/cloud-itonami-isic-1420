# Operator Quickstart — Fur Garment & Accessory Manufacturing

Shortest path from clone to a verified local dry-run for **ISIC 1420** (`cloud-itonami-isic-1420`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-1420.git
cd cloud-itonami-isic-1420
```
...
- Blueprint governor key: `fur-governor`
- Likely source path: `fur.governor.cljc`
