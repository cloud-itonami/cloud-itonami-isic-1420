# Business Model: Fur Garment & Accessory Manufacturing
...
## Classification
- Repository: `cloud-itonami-isic-1420` ([github.com/cloud-itonami/cloud-itonami-isic-1420](https://github.com/cloud-itonami/cloud-itonami-isic-1420))
- ISIC Rev.5: `1420` — Fur Garment & Accessory Manufacturing
- Domain: `:fur/manufacturing`
- Social impact: :fair-labor :local-industry :species-provenance-transparency
- Actor: `:fur-governor` — an independent Governor in the fleet's Sealed-LLM
...
## Customer
An operator running this vertical as an OSS business — :fur/manufacturing — who wants
...
One managed tenant (:fur/manufacturing):
...
- Do not bypass the `:fur-governor` for production decisions.
